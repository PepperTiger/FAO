...
```{r}
#quantité de manioc exportée en milliers de tonnes en Thailande
prod_t%>%
...
### Relation entre le nombre d'habitant sur Terre et le nombre de personnes en sous-nutrition
