...
fichiers<-list.files(path = "C:/Users/lothe/Dropbox/Educatif/IA School/Projets/Projet FAO/FAO/fichiers_csv/", pattern = NULL, all.files = FALSE,
...
for (i in 1:length(fichiers)){
  assign(x=str_sub(fichiers[i],1,-5),
         value=read.csv(paste0("C:/Users/lothe/Dropbox/Educatif/IA School/Projets/Projet FAO/FAO/fichiers_csv/",fichiers[i])))
}
...
#les 20 aliments les plus riches en prot�ines 
