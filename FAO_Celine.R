...
# Combien d'humains pourraient Ítre nourris si toute la disponibilitÈ alimentaire en produits vÈgÈtaux (Food),
#la nourriture vÈgÈtale destinÈe aux animaux (Feed) et les pertes de produits vÈgÈtaux (Waste) Ètaient utilisÈs pour de la nourriture ?
...
#crÈation de la table sous-nutrition
unique(unourished_people$Unit)    #toutes les donnÈes sont en millions
...
#3.6
#Donnez les 3 produits qui ont la plus grande valeur pour chacun des 2 ratios (vous aurezdonc 6 produits ‡ citer)
...
#3.7Combien de tonnes de cÈrÈales pourraient Ítre libÈrÈes si les USA diminuaient
...
#3.8 En ThaÔlande, quelle proportion de manioc est exportÈe ? Quelle est la proportion de personnes en sous-nutrition ?
